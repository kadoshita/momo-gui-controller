...
electron_1.ipcMain.on('ping', function (e) {
    console.log('ping -> pong');
    return e.sender.send('pong');
});
var getResourceDirectory = function () {
    return process.env.NODE_ENV === 'development'
        ? path_1.default.join(process.cwd(), 'dist')
        : path_1.default.join(process.resourcesPath, 'app.asar.unpacked', 'dist');
};
var createWindow = function () {
    var win = new electron_1.BrowserWindow({
        ...
        webPreferences: {
            ...
            preload: process.env.NODE_ENV === 'development' ? path_1.default.resolve(getResourceDirectory(), 'preload.js') : ''
        }
    });
